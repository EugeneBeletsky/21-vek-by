...
test('T1 [search] Search input is visible' , { tag: ['@regression', '@P1'] }, async () => {
...
test('T3 [search] All products have a price more than 0', { tag: ['@regression', '@P2'] }, async () => {
  await searchProductItem.waitForSearchResult();
...
test('T4 [search] All products have a name', { tag: ['@regression', '@P2'] }, async () => {
  await searchProductItem.waitForSearchResult();
